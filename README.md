# 🏗 scaffold-eth -Suspicius-Heterochromic-Loogie
...
> clone/fork 🏗 scaffold-eth heterochromic-loogies-master branch:

```
git clone -b heterochromic-loogies-master https://github.com/scaffold-eth/scaffold-eth.git heterochromic-loogies-master
```

> install and start your 👷‍ Hardhat chain:

```bash
cd heterochromic-loogies-master
yarn install
yarn chain
```
